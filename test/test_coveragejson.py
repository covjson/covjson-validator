...
VALIDATOR = validator.create_custom_validator("/schemas/coveragejson")


SAMPLE_DOMAIN = "Grid_x=1,y=1,z=0,t=0"


def test_valid_domain(get_domain):
...
def test_missing_type(get_domain):
...
def test_misspelled_type(get_domain):
