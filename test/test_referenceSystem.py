...
VALIDATOR = validator.create_custom_validator("/schemas/referenceSystem")


def test_geographic_rs():
...
def test_missing_target_concept():
...
def test_invalid_target_concept():
